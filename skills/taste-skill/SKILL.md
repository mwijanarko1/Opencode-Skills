...
description: Primary premium-design skill for creating new frontend UI from scratch. Use for greenfield interfaces, landing pages, and new product surfaces. Do not use as the primary skill for redesigning existing UI.
---
...
Use this as the primary design mode for new interfaces.
