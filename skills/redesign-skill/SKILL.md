...
description: Primary redesign skill for existing websites and apps. Use when improving current UI without rewriting the product. Do not use as the primary mode for greenfield interface creation.
---
...
Use this as the primary design mode when the project already has UI, styling, and behavior that must be preserved.
